...
*please remark that it does require a valid Sysmac license. 
Like my work? [Add Roelof Jan Boer on LinkedIn](https://www.linkedin.com/in/rjboer/)

<img width="1105" height="750" alt="image" src="https://github.com/user-attachments/assets/0148391e-b4d5-4ad3-8968-1c60e8c20645" />
...
2. Start OMRON MCP using the instructions for your platform and make it available to your AI client (tested with Codex/Antigravity).
3. Open an AI tool that supports MCP, such as Codex, Cursor or Antigravity, and add/configure OMRON MCP as an MCP server. The client starts the MCP initialization handshake and then discovers the available tools.
...
4. Review the proposed code and project changes (in your editor; Codex, Antigravity etc.).
5. Apply the approved changes (in your editor; Codex, Antigravity etc.).
6. Validate the result in Sysmac Studio.
